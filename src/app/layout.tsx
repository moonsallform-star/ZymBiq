...
const PageTransition = dynamic(() => import("@/components/providers/page-transition"), { ssr: false });
const NavigationProgress = dynamic(() => import("@/components/providers/progress-bar"), { ssr: false });
